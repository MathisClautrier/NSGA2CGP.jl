...
```
Playing Atari games using classic NSGA2CGP on RAM values
...
function play_atari(ind::NSGA2CGPInd, rom_name::String; seed=0, max_frames=18000, render=false)
    ale = ALE_new()
